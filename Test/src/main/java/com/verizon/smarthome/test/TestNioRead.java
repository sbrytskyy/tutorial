...
public class TestNioRead {
	...
	private static void readRawBytes() throws IOException {
		final FileInputStream fis = new FileInputStream("/Users/brytsse/temp/test.txt");
		...
		byte[] contentsOnly = Arrays.copyOf( buffer.array(), buffer.position() );
		showStats("after Arrays.copyOf", fc, buffer);
